...
export const QUICK_REFERENCE: Record<CategoryId, string[]> = {
  pressure: ["타이어 공기압 약 32 psi ≈ 2.2 bar", "1기압(atm) = 약 10m 수심 압력", "1 kgf/cm² ≈ 1 atm ≈ 14.7 psi", "1 bar = 100 kPa"],
  viscosity: ["물(20°C) ≈ 1 cP", "꿀 ≈ 2,000~10,000 cP", "엔진오일 ≈ 100~250 cP"],
  kinematicViscosity: ["물(20°C) ≈ 1 cSt", "엔진오일(100°C) ≈ 8~14 cSt", "1 St = 100 cSt"],
  energy: ["밥 한 공기 ≈ 300 kcal", "1 kWh = 860 kcal (전기요금 단위)", "1 BTU ≈ 0.252 kcal (냉난방 용량)"],
  length: ["1 inch = 25.4 mm (나사/배관 규격)", "1 ft = 30.48 cm (건축)", "A4 용지 폭 ≈ 210 mm"],
  mass: ["1 lb ≈ 0.454 kg (약 반 킬로)", "1 oz ≈ 28.3 g (귀금속 단위)", "1 ton = 1,000 kg"],
  volume: ["생수 1병 = 500 mL", "1 gal ≈ 3.79 L (미국 연비 단위)", "원유 1 bbl ≈ 159 L"],
  temperature: ["물 끓는점: 100°C = 212°F", "체온 36.5°C = 97.7°F", "절대영도: −273.15°C = 0 K"],
  area: ["아파트 30평 ≈ 99.17 m²", "축구장 ≈ 0.7 ha", "1 acre ≈ 약 1,224 평"],
  power: ["가정용 에어컨 약 1~3 RT", "자동차 100 hp ≈ 74.6 kW", "1 RT ≈ 3,517 W (냉동능력)"],
  force: ["사과 1개 무게 ≈ 1 N", "1 kgf = 약 9.81 N (중력가속도)", "1 tonf ≈ 9,807 N"],
  speed: ["고속도로 100 km/h ≈ 62.1 mph", "태풍급 풍속 ≈ 34 knot 이상", "1 m/s = 3.6 km/h"],
  flowRate: ["가정 수도 ≈ 10~15 LPM", "공조 풍량: 1 CMH ≈ 0.59 CFM", "소방 펌프 ≈ 500~1,000 GPM"],
};
